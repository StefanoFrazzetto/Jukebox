...
<div id="burner_modal" class="modalBody" data-mcs-theme="dark">
    ...
    <div id="burner_step1">
        ...
        <button class="burner_step1-set" id="burner_step1-reset"><img style="height: 90%;"
    ...
    function burnerHandler(action_value) {
        ...
        $.ajax({
            ...
            $.each(output, function (index, value) {
                ...
                // TL;DR : The burner is ready to burn.
                // If the burner is not burning and it just display the message, show the burn and cancel button.
                if (index.toLowerCase() == "message" && output['status'].toLowerCase() == "idle") {
                    $('#burner_step2').show();
                }
            });
        });
