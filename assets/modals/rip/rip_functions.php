...
function startRipping()
{
    ...
    exec("$scripts/rip.sh >> /tmp/cdparanoia_log.log 2>&1 &");
}
...
function startEncoding()
{
    ...
    exec("$scripts/encode.sh >> /tmp/lame_log.log 2>&1 &");
}
...
{
    global $cdnumber, $encoding_folder;
...
{
    global $encoding_folder, $cdnumber;
