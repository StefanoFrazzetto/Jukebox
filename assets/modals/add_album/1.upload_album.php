...
<div class="modalFooter">
    ...
    <?php         
        ...
        if( $_SESSION['CD'] > 1){
    ?>
        <div class="box-btn pull-right" onclick="openModalPage('assets/modals/add_album/2.fix_titles.php');">Cancel</div>
    <?php } ?>
    
    <div class="box-btn pull-right" id="nextBtn" style="display: none" onclick="openModalPage('assets/modals/add_album/2.fix_titles.php');">Next</div>
</div>
