...
//
// // Bands
// var bandsList = getBands();
// var filteredBands = getFilteredBands(context, bandsList);
//
// var output = context.createGain();//getSum(context, filteredBands, baseGain);
//
// filteredBands.reduce(function (prev, curr) {
//     prev.connect(curr);
//     return curr;
...
//
// function getFilteredBands(context, bands) {
//     var filteredBands = [];
//
...
//         }
//
//         band.frequency.value = bands[i];
//         band.gain.value = gainDb;
//         band.Q.value = 1;
//
//         filteredBands.push(band);
//     }
...
// }
//
// function getInvertedGains(context, bands) {
//     var invertedGains = [];
//
//     for (var i = 0; i < bands.length; i++) {
...
//         gain.gain.value = -1.0;
//
//         invertedGains.push(gain);
//     }
//
//     return invertedGains;
// }
//
// function getGains(context, filteredBands) {
//     var gains = [];
//
//     for (var i = 0; i < filteredBands.length; i++) {
//         var gain = context.createGain();
//         filteredBands[i].connect(gain);
//
//         gains.push(gain);
//     }
//
...
// }
//
// function connectFilteredBandsToAudioNode(sourceNode, filteredBands) {
//     filteredBands.forEach(function (band) {
//         sourceNode.connect(band);
//     });
// }
//
// function doMagicalThingsWithBands(filteredBands, invertedGains, baseBand) {
//     for (var i = 0; i < filteredBands.length; i++) {
//         filteredBands[i].connect(invertedGains[i]);
//         invertedGains[i].connect(baseBand);
//     }
// }
//