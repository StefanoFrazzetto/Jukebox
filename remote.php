...
<body>
	...
	<div id="container">
		...
		<div id="log"></div>
			...
			<button onclick="sendEvent('refresh')">REFRESH</button> <input type="text" name="" id="album_id" placeholder="album_id" value="642"> <button onclick="
...
<script type="text/javascript">
	...
	function updatePlayButton(){
		if(playerStatus.playing == true){
			...
			$('#play-pause i').addClass('fa-play').removeClass('fa-pause');
			stopTimer();
		}
	}
